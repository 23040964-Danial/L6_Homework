    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.buttonContainer}>
                <Button title="Water" onPress={() => setSelectedSection('Water')} color={selectedSection === 'Water' ? 'blue' : 'gray'} />
                <Button title="Thunder" onPress={() => setSelectedSection('Thunder')} color={selectedSection === 'Thunder' ? 'yellow' : 'gray'} />
            </View>
